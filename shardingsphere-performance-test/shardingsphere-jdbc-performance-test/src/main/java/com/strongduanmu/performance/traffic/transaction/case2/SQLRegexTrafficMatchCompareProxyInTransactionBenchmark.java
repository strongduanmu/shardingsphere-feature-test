package com.strongduanmu.performance.traffic.transaction.case2;
...
@Threads(10)
@State(Scope.Thread)
public class SQLRegexTrafficMatchCompareProxyInTransactionBenchmark {
    ...
    @Benchmark
    public void testSQLRegexTrafficMatchInTransaction() throws SQLException {
    ...
    /*@Benchmark
    public void testShardingSphereProxyInTransaction() throws SQLException {
    ...
    public static void main(String[] args) throws RunnerException {
        Options options = new OptionsBuilder().include(SQLRegexTrafficMatchCompareProxyInTransactionBenchmark.class.getSimpleName()).forks(1).measurementIterations(5).warmupIterations(5).build();
