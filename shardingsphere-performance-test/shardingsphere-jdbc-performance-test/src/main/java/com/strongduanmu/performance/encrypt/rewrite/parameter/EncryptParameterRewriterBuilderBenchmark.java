...
public class EncryptParameterRewriterBuilderBenchmark {
    ...
    public void setUp() {
        ...
        EncryptRule encryptRule = new EncryptRule(new EncryptRuleConfiguration(tables, Collections.singletonMap("TEST", new ShardingSphereAlgorithmConfiguration("AES", props))));
